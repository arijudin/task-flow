...
export default function NewTaskPage({ params }: NewTaskPageProps) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    formDataObj.append("projectId", params.id)
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div className="space-y-2">
                ...
                {errors.priority && <p className="text-sm text-red-600">{errors.priority[0]}</p>}
              </div>
            </div>
            <div className="space-y-2">
              <Label htmlFor="dueDate">Due Date</Label>
              <Input id="dueDate" name="dueDate" type="date" value={formData.dueDate} onChange={handleChange} />
              {errors.dueDate && <p className="text-sm text-red-600">{errors.dueDate[0]}</p>}
            </div>
