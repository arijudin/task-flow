      ...
      <Card>
        ...
        <CardFooter className="flex justify-between">
          {task.status !== "completed" && (
            <Button size="sm" variant="outline" onClick={() => handleStatusChange("completed")} disabled={isUpdating}>
              Mark Complete
            </Button>
          )}
          {task.status === "todo" && (
            <Button size="sm" variant="outline" onClick={() => handleStatusChange("in-progress")} disabled={isUpdating}>
              Start Task
            </Button>
          )}
          {task.status === "completed" && (
            <Button size="sm" variant="outline" onClick={() => handleStatusChange("todo")} disabled={isUpdating}>
              Reopen Task
            </Button>
          )}
        </CardFooter>
